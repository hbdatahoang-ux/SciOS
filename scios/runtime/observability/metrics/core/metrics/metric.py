...
class Metric:
    ...
    def set(
        ...
        self._state.previous_value = self._state.value
        self._state.value = value

        now = datetime.now(timezone.utc)

        self._state.timestamp = now
        self._state.last_value_at = now
    ...
    def delta(self):
        ...
        if (
            self._state.previous_value is None
            or self._state.value is None
        ):
            return None

        return self._state.value - self._state.previous_value
    ...
    def changed(self) -> bool:
        ...
        return self._state.previous_value != self._state.value 
