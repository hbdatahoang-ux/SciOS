...
def test_multiple_attributes(
    ...
    assert (
        populated_attributes.get("service")
        == "scios"
    )

    assert (
        populated_attributes.get("version")
        == "0.3"
    )
